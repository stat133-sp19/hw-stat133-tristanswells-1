---
title: "workout01-tristan-wells.Rmd"
...
knitr ::include_graphics("../images/Stephen_Curry_2016.jpg")
```
...
library(knitr)
total_points <- effective_shooting %>%
  select(name, made) %>%
  arrange(desc(made))
knitr :: kable(total_points, caption = "Total Points Scored per Player")
```
...
```{r echo = FALSE, fig.align='center'}
library(knitr)
total_shots <- effective_shooting %>%
  select(name, total) %>%
  arrange(desc(total))
knitr :: kable(total_shots, caption = "Total Shots Made per Player")
```
...
```{r echo = FALSE, fig.align='center'}
library(knitr)
effective_perc <- effective_shooting %>%
  select(name, effective_perc_made) %>%
  arrange(desc(effective_perc_made))
knitr :: kable(effective_perc, caption = "Effective Shot Percentage per Player")
```
...
```{r echo = FALSE, fig.align='center'}
library(knitr)
two_point_percentage <- effective_shooting %>%
  select(name, two_point_perc) %>%
  arrange(desc(two_point_perc))
knitr :: kable(two_point_percentage, caption = "Percentage of Two-Pointers Made per Player")
```
...
```{r echo = FALSE, fig.align='center'}
library(knitr)
three_point_percentage <- effective_shooting %>%
  select(name, three_point_perc) %>%
  arrange(desc(three_point_perc))
knitr :: kable(three_point_percentage, caption = "Percentage of Three-Pointers Made per Player")
```
